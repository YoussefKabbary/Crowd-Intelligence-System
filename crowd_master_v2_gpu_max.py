...
â•‘  CROWD MASTER  |  Enterprise AI Surveillance Platform  v5.2         â•‘
â•‘  â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€  â•‘
â•‘  NEW IN v5.2:                                                        â•‘
â•‘    âœ“ Tkinter GUI launcher â€” browse video before run starts         â•‘
â•‘    âœ“ GPU FP16 (half-precision) â€” 2Ã— faster on CUDA                 â•‘
â•‘    âœ“ model.fuse() â€” fused Conv+BN for faster inference             â•‘
â•‘    âœ“ torch.backends.cudnn.benchmark = True                         â•‘
â•‘    âœ“ Center-based tracking (EMA) â€” no more box trailing            â•‘
â•‘    âœ“ Head offset prediction â€” head never lost                      â•‘
â•‘    âœ“ Adaptive inference resolution based on real FPS               â•‘
â•‘    âœ“ O key â€” toggle detection on/off (tracking continues)          â•‘
â•‘    âœ“ All v5.1 fixes retained                                       â•‘
â•‘                                                                      â•‘
â•‘  ARCHITECTURE: 6-Thread async pipeline                               â•‘
â•‘    VideoPlayerThread  â†’ exact-FPS playback, independent            â•‘
â•‘    DetectionWorker    â†’ YOLO + head + sliced + TTA (async)          â•‘
â•‘    AnalyticsThread    â†’ drift / forecast / anomaly                  â•‘
â•‘    OnlineLearner      â†’ continuous CNN fine-tuning                  â•‘
â•‘    AutoRetrainer      â†’ nightly deep retrain                        â•‘
â•‘    Main Thread        â†’ display only (zero lag)                     â•‘
â•‘                                                                      â•‘
â•‘  GATE / DOOR SYSTEM:                                                 â•‘
â•‘    G  â†’ enter gate draw mode (click+drag to place gates)            â•‘
â•‘    X  â†’ clear all gates                                             â•‘
â•‘    Gates saved to gates.json, auto-reloaded on next run             â•‘
â•‘                                                                      â•‘
â•‘  KEYS:                                                               â•‘
â•‘    Q quit   P pause   N stats   B boxes   H heads   M heatmap       â•‘
â•‘    Z zones  F full    I enhance  T TTA    E ONNX    Ctrl+R train    â•‘
â•‘    G gate-draw   TAB select-gate   R reverse   ESC deselect         â•‘
â•‘    X delete-selected  (X clears all when nothing selected)          â•‘
â•‘    O  toggle detection on/off (tracking keeps running)              â•‘
â•‘    +/-  speed   V/C volume   ]/[ zoom   WASD/arrows pan             â•‘
â•‘    .  seek+5s   ,  seek-5s   (audio starts automatically)           â•‘
...
# â”€â”€ Tkinter GUI launcher â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
try:
...
# â”€â”€ GPU performance tuning â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
def highgui_available() -> bool:
    ...
    # Always re-check â€” never cache a False result permanently
    test_win = "__crowd_master_highgui_test__"
    try:
        cv2.namedWindow(test_win, cv2.WINDOW_NORMAL)
        cv2.waitKey(1)          # pump the GUI event queue so the window actually paints
        cv2.destroyWindow(test_win)
        cv2.waitKey(1)          # ...and pump it again so the destroy actually takes
...
#  CONFIG  â€” single source of truth for all settings
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
class Config:
    # â”€â”€ Paths - Cross-Platform with Environment Variables â”€â”€â”€â”€â”€â”€
    ...
    BODY_MODEL  = "yolov8s.pt"      # upgraded from yolov8n -- RTX 3050 has headroom
    HEAD_MODEL  = "yolov8s-pose.pt" # upgraded from yolov8n-pose

    # â”€â”€ Tracker â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    TRACKER     = "bytetrack.yaml"

    # â”€â”€ Inference resolution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    INFER_W      = 960              # upgraded from 640
    INFER_H      = 540              # upgraded from 360
    DETECT_EVERY = 1         # â˜… FIX: was 3 â†’ faster detection per frame

    # â”€â”€ Adaptive confidence â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    BODY_CONF_BASE = 0.25
    BODY_IOU       = 0.45
    HEAD_CONF_BASE = 0.20
    HEAD_IOU       = 0.35
    ...
    # â”€â”€ Sliced inference â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    USE_SLICED    = True             # enabled -- 3050 can afford tiled inference for dense crowds
    SLICE_ROWS    = 2
    SLICE_COLS    = 2
    SLICE_OVERLAP = 0.20

    # â”€â”€ Test-Time Augmentation â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    USE_TTA = True                       # enabled -- extra augmented passes now affordable

    # â”€â”€ Detection fusion â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    FUSION_DIST         = 55
    HEAD_PERSIST_FRAMES = 5

    # â”€â”€ Dense-scene fallback threshold â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    DENSE_FALLBACK_THR  = 40

    # â”€â”€ Gate / Door system â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    GATE_LINE_THICKNESS = 3
    GATE_CROSS_DIST     = 70  # â˜… FIX: was 40 â†’ wider zone catches more crossings
    GATE_COLORS         = [
    ...
    # â”€â”€ Online learning â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ONLINE_LR           = 3e-5
    ONLINE_BATCH        = 32         # upgraded from 4 -- more VRAM headroom
    ONLINE_EVERY_SEC    = 2
    BUFFER_SIZE         = 1000
    MIN_BUFFER_TO_TRAIN = 16

    # â”€â”€ Drift â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    DRIFT_WINDOW    = 30
    DRIFT_THRESHOLD = 0.40

    # â”€â”€ Forecasting (Transformer) â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ REST API â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    API_ENABLED = True
    API_PORT    = 5055

    # â”€â”€ Auto retrain â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    RETRAIN_HOUR   = 3
    RETRAIN_EPOCHS = 40                  # upgraded from 15

    LOG_EVERY = 30
    
    # â”€â”€ Device - Auto-detect with environment override â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ FP16 (half precision) â€” 2Ã— faster on GPU, no accuracy loss â”€â”€
    ...
    # â”€â”€ Adaptive resolution â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    # â”€â”€ EMA smoothing alpha for track centers â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class Gate:
    MIN_CROSS_FRAMES = 1
    RESET_DIST_MULT  = 1.8   # â˜… FIX: was 2.5 â†’ re-trigger sooner
    ...
    def reverse_direction(self):
        ...
        logger.info(f"Gate {self.gate_id}: direction reversed â†’ in_side={self.in_side}")
...
class GateManager:
    ...
    def toggle_draw_mode(self, win_name: str, display_scale: float):
        ...
        if self._draw_mode:
            logger.info("Gate draw mode ON â€” click+drag to draw a gate line.")
            cv2.setMouseCallback(win_name, self._mouse_cb)
        else:
            logger.info("Gate draw mode OFF â€” gates saved.")
        ...
        if event == cv2.EVENT_LBUTTONDOWN:
            ...
            if self._start_pt and self._preview:
                ...
                if math.hypot(x2-x1, y2-y1) > 20:
                    ...
                    logger.info(f"Gate {gid} created: ({x1},{y1})â†’({x2},{y2})")
    ...
    def draw_preview(self, display_frame: np.ndarray, scale: float = 1.0):
        ...
        if self._draw_mode:
            ...
            cv2.putText(display_frame,
                        "GATE DRAW MODE  â€”  Click+drag to place gate. Press G to finish.",
...
class AudioPlayerThread(threading.Thread):
    ...
    def __init__(self, video_path: str, fps: float = 30.0):
        ...
        self._play_t    = 0.0
        self._vol       = 1.0
        self._ffplay    = self._find_ffplay()          # â˜… FIX
    ...
    def set_volume(self, v: float):
        ...
        self._vol = new_vol
        # â˜… FIX: restart with new volume so change takes effect immediately
        with self._lock:
    ...
    def _launch(self, start_sec: float):
        ...
        try:
            cmd = [
                self._ffplay,          # â˜… FIX: use found path, not bare "ffplay"
                "-nodisp", "-autoexit",
                "-loglevel", "quiet",
                "-ss", f"{start_sec:.2f}",
                "-volume", str(vol_int),  # â˜… FIX: actual volume control
                self._path,
            ]
            ...
            logger.warning(f"Audio: ffplay launch failed â€” {e}")
            self._proc = None
...
class DensityEstimator:
    ...
    def estimate(self, gray: np.ndarray, yolo_count: int) -> int:
        # â˜… FIX: old formula gave 173 with only 7 people (supermarket shelves).
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
#  DETECTION WORKER
#  â˜… BUG FIX: cnn_c is now computed BEFORE accurate_count
#    (was previously computed AFTER, causing NameError on frame 1
#     which silently crashed the thread â†’ all stats stayed at 0,
...
class DetectionWorker(threading.Thread):
    def __init__(self, detect_queue, result: DetectionResult,
        ...
        self._BOX_ALPHA = 0.88   # â˜… FIX: was 0.60 â†’ faster box following
    ...
    def run(self):
        while not self._stop.is_set():
            ...
            # â”€â”€ Adaptive resolution based on real FPS â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Skip detection if toggled off (O key) â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ BODY DETECTION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ TTA â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ Scale to original coords â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            bo = bi.copy()
            if len(bo) > 0:
                bo[:, 0] *= sx; bo[:, 2] *= sx
                bo[:, 1] *= sy; bo[:, 3] *= sy

            # â”€â”€ Re-run with tracker if gates exist â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ BOX EMA SMOOTHING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            ...
            # â”€â”€ HEAD DETECTION â€” every frame (â˜… FIX: removed % 2 skip) â”€â”€
            self._head_tick += 1
            hc_i, hcnt = self.head_det.detect(small, use_tta=False)
            hc_o = [(int(x*sx), int(y*sy)) for (x, y) in hc_i]
            self._head_cache = (hc_o, hcnt)

            # â”€â”€ GATE CROSSING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            # Update center tracker â€” this is the source of truth
            ...
            # â”€â”€ FUSION â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            final, orphans, fconf = self.fusion.fuse(
                bo, bc, hc_o, hcnt, body_count)

            # â”€â”€ DENSITY FALLBACK â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            dens = self.density_est.estimate(gray, final)

            # â”€â”€ TEMPORAL SMOOTHING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            self._smooth.append(final)
            smoothed = int(round(np.mean(self._smooth)))

            # â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
            #  â˜… FIX: CNN inference BEFORE accurate_count
            #    Previously cnn_c was defined AFTER the block
            #    that used it â†’ NameError â†’ thread crash â†’ all 0
            # â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
            cnn_c = self.learner.inference(small)

            # â”€â”€ ACCURATE COUNT â€” 4-signal fusion â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
            # â˜… FIX: density weight cut from 10-14% â†’ 3% to stop
            ...
            # â”€â”€ ONLINE LEARNING â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
...
class PeakTimeTracker:
    ...
    def build_report(self, threshold: int, report_path: str,
        ...
        if gate_mgr.gates:
            lines.append("â”€â”€ GATE / DOOR STATISTICS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€")
        ...
        lines.append("â”€â”€ SESSION PERFORMANCE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€")
        ...
        lines.append("â”€â”€ CROWD STATISTICS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€")
        ...
        lines.append("â”€â”€ CROWDED PERIODS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€")
        ...
        lines.append("")
        lines.append("â”€â”€ TOP 5 BUSIEST MOMENTS â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€")
        ...
        lines.append("")
        lines.append("â”€â”€ BUSIEST MINUTE â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€")
        ...
        lines.append("â”€â”€ HOURLY CROWD BREAKDOWN â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€")
        ...
        lines.append("")
        lines.append("â”€â”€ DETECTION QUALITY SUMMARY â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€")
...
def start_api(result: DetectionResult, gate_mgr: GateManager, cfg: Config):
    ...
    try:
        ...
        logger.info("FastAPI not installed â€” API disabled.")
...
def draw_boxes(frame: np.ndarray, boxes: np.ndarray,
    ...
    for i, box in enumerate(boxes):
        ...
        _draw_corner_box(frame, x1, y1, x2, y2, c)
        _draw_pill_label(frame, f"#{tid}  {conf:.0%}", x1, y1, c)
    return frame


def _draw_corner_box(frame, x1, y1, x2, y2, color, thickness=2, corner_frac=0.22):
    """Bracket-corner box (modern AI/surveillance look) instead of a full outline."""
    w, h = x2 - x1, y2 - y1
    cl = max(10, int(min(w, h) * corner_frac))
    cv2.rectangle(frame, (x1, y1), (x2, y2), color, 1, cv2.LINE_AA)  # faint full outline
    for (cx, cy, dx, dy) in [(x1,y1,1,1), (x2,y1,-1,1), (x1,y2,1,-1), (x2,y2,-1,-1)]:
        cv2.line(frame, (cx, cy), (cx + dx*cl, cy), color, thickness, cv2.LINE_AA)
        cv2.line(frame, (cx, cy), (cx, cy + dy*cl), color, thickness, cv2.LINE_AA)


def _draw_pill_label(frame, text, x1, y1, color, font_scale=0.44):
    """Semi-transparent, padded label instead of a hard-filled tag box."""
    font = cv2.FONT_HERSHEY_SIMPLEX
    (tw, th), baseline = cv2.getTextSize(text, font, font_scale, 1)
    pad_x, pad_y = 8, 5
    bw, bh = tw + pad_x*2, th + pad_y*2 + baseline
    ly1 = max(bh, y1 - 4)
    bx1, by1, bx2, by2 = x1, ly1 - bh, x1 + bw, ly1
    overlay = frame.copy()
    ...
    cv2.putText(frame, text, (bx1 + pad_x, by2 - pad_y - baseline//2),
...
def generate_pdf_report(peak_track: PeakTimeTracker,
    ...
    try:
        ...
        # Ø­Ø³Ø§Ø¨ Ø§Ù„Ø£Ø¨Ø¹Ø§Ø¯ Ø¨Ø­ÙŠØ« ØªØªÙ†Ø§Ø³Ø¨ Ù…Ø¹ Ø§Ù„ØµÙØ­Ø© Ø¨Ø¯ÙˆÙ† overflow
        page_w, page_h = A4
        margin = 40
        max_w = page_w - margin * 2
        max_h = page_h - margin * 2
        # Ø­Ø§ÙØ¸ Ø¹Ù„Ù‰ Ù†Ø³Ø¨Ø© Ø§Ù„Ø£Ø¨Ø¹Ø§Ø¯
        ...
        logger.info("reportlab not installed â€” PNG saved.")
    except Exception as e:
...
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
#  CENTER TRACKER  â€” EMA smoothing per track ID
...
class CenterTracker:
    ...
    alpha=0.70 â†’ fast response (~3 frames to converge) + smooth.
...
class VideoLauncher:
    ...
    Call VideoLauncher.run() â€” blocks until user clicks Start or closes.
    """
    ...
    def run(self) -> Optional[str]:
        ...
        if not _TK_AVAILABLE:
            logger.warning("tkinter not available â€” skipping GUI launcher.")
            return cfg.VIDEO_PATH if os.path.exists(cfg.VIDEO_PATH) else None

        root = tk.Tk()
        root.title("Crowd Master v5  â€”  Select Source")
        ...
        tk.Label(root, text="ðŸŽ¥  CROWD MASTER v5",
        ...
        # â”€â”€ Input source â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Video path â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Data dir â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        def browse_dir():
            ...
            if d: dir_var.set(d)
        tk.Button(frm2, text="Changeâ€¦", command=browse_dir,
                  font=FONT, bg=BTN_BG, fg=ACCENT,
                  relief="flat", padx=10, cursor="hand2").pack(side="left")

        # â”€â”€ Device info â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        dev_lbl = ("ðŸŸ¢ GPU (CUDA)" if self.cfg.DEVICE == "cuda"
                   else "ðŸŸ¡ CPU (no GPU)")
        ...
        # â”€â”€ Key hint â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        # â”€â”€ Start / Cancel buttons â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
        ...
        tk.Button(btn_frm, text="  â–¶  Start Analysis  ",
                  command=on_start,
...
def run(cfg: Config):
    ...
    if os.path.exists(cfg.MODEL_SAVE):
        try:
            ...
            logger.warning(f"CNN load failed ({e}) â€” starting fresh.")
    cnn_model.eval()
    ...
    if cfg.USE_FP16:
        body_yolo.model.half()   # FP16 â€” 2Ã— faster on GPU
    ...
    if display_enabled:
        ...
        logger.warning(
            "OpenCV HighGUI unavailable â€” running in headless mode (no video window). "
            "To get the video window: pip uninstall -y opencv-python-headless opencv-python && pip install opencv-python"
        )
        # Don't quit â€” keep processing and logging, just no display window
    ...
    print("\n" + "="*58)
    print("       CROWD MASTER v5  â€”  SESSION SUMMARY")
    print("="*58)
...
if __name__ == "__main__":
    ...
    # â”€â”€ Tkinter video selector â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€â”€
    ...
    if not skip_gui:
        ...
        chosen   = launcher.run()
        if not chosen:
            logger.info("No video selected â€” exiting.")
            sys.exit(0)
    ...
    logger.info("=" * 70)
    logger.info("âœ… All checks passed â€” Starting system...")
    logger.info("=" * 70)
